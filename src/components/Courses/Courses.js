...
const CourseCard = ({ course }) => {
    ...
    return (
      <div class="card-component p-2">
        <div class="card">
          <div class="card-body row" onClick={toggleAssignments}>
            ...
            <div class="card-text col-sm-2">
              <strong>Created Date: </strong>{course.createDate}
            </div>
            <div class="card-text col-sm-2">
              <strong>Updated Date: </strong>{course.createDate}
            </div>
            <div class="card-text col-sm-2">
            ...
            {showAssignments && (
              <div>
                ...
                <div className="assignment-list row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4">
                  {course.assignments.map((assignment) => (
                    <div key={assignment.assignmentName} className="col">
                      <div className="card">
                        <div className="card-body row">
                          <div class="card-text col-sm-5">
                          <strong>Name: </strong>{assignment.assignmentName}
                          </div>
